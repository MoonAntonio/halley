...
PluginType DummyMoviePlugin::getType()
{
	return PluginType::MovieAPI;
}

String DummyMoviePlugin::getName()
{
	return "Movie/Dummy";
}

HalleyAPIInternal* DummyMoviePlugin::createAPI(SystemAPI*)
{
	return new DummyMovieAPI();
}
